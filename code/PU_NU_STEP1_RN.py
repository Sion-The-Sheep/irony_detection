...
df_hurei_reliable.to_csv("../data/step1/tweetdata_hurei_reliable.csv",header=False,index=False,encoding="utf-8")
...
df_hurei_more_reliable.to_csv("../data/step1/tweetdata_hurei_more_reliable.csv",header=False,index=False,encoding="utf-8")
...
for i in range(5):
  ...
  save_path = "../model/hozon_sarcasm_detection_PU" + str(num)
...
for i in range(5):
  ...
  save_path = "../model/hozon_sarcasm_detection_baceline" + str(num)
