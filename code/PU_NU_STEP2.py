...
df_seirei = pd.read_csv("../data/step1/tweetdata_hurei_reliable_without_aisatu_useCLUSTERING.csv",encoding="utf_8",names=('honbun','rep','inyou','label'),dtype=object)
...
for q in range(5):
    ...
    save_path = "../model/hozon_spy_RP" + str(spy_pattern)
