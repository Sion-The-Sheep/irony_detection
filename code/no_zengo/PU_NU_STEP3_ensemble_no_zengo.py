...
for i in range(5):
    ...
    model_name = "../model/hozon_sarcasm_detection_baceline_no_zengo" + str(num) + "/model_epoch2.model" 
...
for i in range(5):
    ...
    model_name = "../model/hozon_sarcasm_detection_PU_no_zengo" + str(num) + "/model_epoch2.model" 
    model = BertForSequenceClassification.from_pretrained(model_name, num_labels=2).to("cuda:0")
    tokenizer = BertTokenizer.from_pretrained("cl-tohoku/bert-base-japanese-whole-word-masking") 
    model.eval()
    r_encorded =  tokenizer(test, padding=True, return_tensors='pt')                                                                                                                                                                                                               
...
for i in range(5):
    ...
    model_name = "../model/hozon_sarcasm_detection_PU_NU_no_zengo" + str(num) + "/model_epoch2.model" 
    model = BertForSequenceClassification.from_pretrained(model_name, num_labels=2).to("cuda:0")
    tokenizer = BertTokenizer.from_pretrained("cl-tohoku/bert-base-japanese-whole-word-masking") 
    model.eval()
    r_encorded =  tokenizer(test, padding=True, return_tensors='pt')                                                                                                                                                                                                               
