...
df_hurei_reliable = pd.read_csv("../../data/step2/tweetdata_seirei_reliable.csv",encoding="utf_8",names=('honbun','rep','inyou','label'))
df_hurei_more_reliable = pd.read_csv("../../data/step2/tweetdata_seirei_more_reliable.csv",encoding="utf_8",names=('honbun','rep','inyou','label'))
