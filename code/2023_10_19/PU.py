#アンサンブル学習の性能の一貫性を確認するために、繰り返し信頼できるフレイのランダムサンプリングをおこない、各シナリオの性能を確認する
...
df_hurei_reliable = pd.read_csv("../../data/step1/tweetdata_hurei_reliable.csv",encoding="utf_8",names=('honbun','rep','inyou','label'))
df_hurei_more_reliable = pd.read_csv("../../data/step1/tweetdata_hurei_more_reliable.csv",encoding="utf_8",names=('honbun','rep','inyou','label'))
